...
{
    public partial class VnsChungTu : DomainObject<System.Guid>, INotifyPropertyChanged
    {
        #region Declarations

		
		private System.DateTime _NgayCt = DateTime.Now;
        private System.DateTime _NgayHt = DateTime.Now;
		...
		public void SetProperty(VnsChungTu des)
		{
			//ID Field
			Id = des.Id;
			//Non ID Field
		...
		public virtual System.DateTime NgayHt
        {
            get { return _NgayHt; }
			set
			{
