...
namespace CapPhatKinhPhi.Report
{
    public partial class InUyNhiemChi : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public InUyNhiemChi(VnsChungTu p_objChungTu, VnsDmDonVi p_KhachHang, IList<VnsGiaoDich> p_lstGiaoDich, Decimal p_SoTien, DateTime p_NgayCt)
        {
            InitializeComponent();
        ...
        private void InUyNhiemChi_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                xrMaDVQHNS_NT.Text += " " + _ObjVnsDmDonvi.MaDvQhns;
                ...
                lblSoTienNopThue1.Text = "Số tiền nộp thuế (Ghi bằng chữ) :Không đồng";
                xrTienDuocHuong1.Text = xrTienTong1.Text;
                ...
                xrTienTong1.Text = tientong1;
                xrTienTong2.Text = tientong2;

                i = 0;
                foreach (string chu in sotienspl)
                {
                    if (i < 12) tienduochuong1 += chu + " ";
